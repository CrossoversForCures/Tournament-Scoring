import { c as create_ssr_component, v as validate_component, a as add_attribute, e as escape, s as setContext, b as spread, d as escape_attribute_value, f as escape_object, g as getContext } from './ssr-CwU1ZNF3.js';
import { c as compute_rest_props, s as subscribe } from './utils-Cb-NyS5y.js';
...
const logo = "/_app/immutable/assets/logo.a_zMvQ0P.png";
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar, "Navbar").$$render($$result, { class: "drop-shadow" }, {}, {
    default: () => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/home" }, {}, {
        default: () => {
          return `<img${add_attribute("src", logo, 0)} class="h-18 me-3" alt="C4C Logo"> <span class="=self-center whitespace-nowrap font-semibold">${validate_component(Heading, "Heading").$$render(
            $$result,
            {
              customSize: "text-2xl",
              color: "text-heading",
            ...
            {
              default: () => {
                return `Elevate 4 Epilepsy ${escape((/* @__PURE__ */ new Date()).getFullYear())}`;
              }
            }
          )}</span>`;
        }
      })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, {}, {}, {})} ${validate_component(NavUl, "NavUl").$$render($$result, { nonActiveClass: "hover:text-hover" }, {}, {
        default: () => {
          return `${validate_component(NavLi, "NavLi").$$render(
            $$result,
            {
              href: "https://www.crossoversforcures.org/"
            },
            {},
            {
              default: () => {
            ...
            $$result,
            {
              href: "https://www.crossoversforcures.org/elevate-4-epilepsy/",
              class: "text-l"
            },
            {},
            {
            ...
            $$result,
            {
              href: "https://www.crossoversforcures.org/about",
              class: "text-l"
            },
            {},
            {
            ...
            $$result,
            {
              href: "https://www.crossoversforcures.org/contact",
              class: "text-l"
            },
            {},
            {
            ...
            $$result,
            {
              href: "https://www.crossoversforcures.org/donate",
              class: "text-l"
            },
            {},
            {
...
//# sourceMappingURL=_layout.svelte-Iok0mYdi.js.map
